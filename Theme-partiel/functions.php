...
function esgi_register_nav_menu()
{
    register_nav_menus(array(
        ...
        'side_menu'    => __('Side Menu', 'ESGI'),
    ));
}


// Ajout de supports au thème
add_action('after_setup_theme', 'partiel_theme_setup');
function partiel_theme_setup()
{
...
function esgi_get_icon($name)
{
    ...
    <path d="M3.4008 18L3.375 10.125H0V6.75H3.375V4.5C3.375 1.4634 5.25545 0 7.9643 0C9.26187 0 10.3771 0.0966038 10.7021 0.139781V3.3132L8.82333 3.31406C7.35011 3.31406 7.06485 4.01411 7.06485 5.04139V6.75H11.25L10.125 10.125H7.06484V18H3.4008Z" fill="#FFFFFF"/>
    </svg>';
...
function esgi_customize_register($wp_customize)
{
    ...
    // Ajout d'un nouveau parametre pour l'image de la homepage
    $wp_customize->add_setting('homepage_image', [
        'type' => 'theme_mod', // or 'option'
        'capability' => 'edit_theme_options',
        'default' => get_template_directory_uri() . '/assets/images/png/1.png',
        'transport' => 'refresh', // or postMessage
        'sanitize_callback' => 'esc_url_raw',
    ]);

    // Ajout d'un controle pour l'image de la homepage
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'homepage_image', [
        'label' => __('Homepage Image', 'ESGI'),
        'section' => 'esgi_section',
